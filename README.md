...
as you can see on the left side above it displays the Letter that represents the previous movement inserted into the database table which is the last button/movement we clicked on in the control panel
